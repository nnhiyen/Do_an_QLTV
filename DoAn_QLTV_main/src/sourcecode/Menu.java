    ...
    while (true) {
        ...
        switch (option) {
            ...
            case 4:
                ...
                break;
            case 5:
                System.out.print("Nhập mã mượn trả cần tìm: ");
                String maTLTim = scanner.nextLine();
                maTLTim = maTLTim.toUpperCase();
            ...
            case 9:
                ...
                System.out.print("Nhập mã mượn trả cần trả sách: ");
                String maTra = scanner.nextLine();
                maTra = maTra.toUpperCase();
                dsMuonTraTL.TraSach(maTra);
                break;
            case 0:
                System.out.println("Thoát chương trình.");
                return;
   ...
   public void menuCTPN() {
    ...
    public void menuTK() {
        ...
        do {
            ...
            System.out.println("|2. Thống kê giao dịch diễn ra trong 1 tháng  |");
            System.out.println("|0. Thoát chương trình.                       |");
            System.out.println("+----------------------------------------------+");
            System.out.print("Mời bạn nhập lựa chọn: ");
            luaChon = scanner.nextInt();  // Kiểm tra lỗi nhập vào có hợp lệ hay không
            ...
            switch (luaChon) {
                case 1:
                    ...
                    break;
                case 2:
                    // Thống kê giao dịch trong một tháng
                ...
                case 0:
                    ...
                    break;
                default:
                    // Xử lý khi người dùng nhập lựa chọn không hợp lệ
